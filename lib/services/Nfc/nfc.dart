...
import '../Nfc/read_screen.dart';
import '../Nfc/write_screen.dart';
          ...
          return ListView(
            children: <Widget>[
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ReadExampleScreen()));
                },
              ),
              ListTile(
                title: const Text("Write NFC"),
                onTap: () {
                   Navigator.push(context, MaterialPageRoute(builder: (context) => WriteExampleScreen()));
